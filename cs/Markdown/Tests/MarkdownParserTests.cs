...
public class MarkdownParserTests
{
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextWithMultipleNonNestedPairedTags(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextWithMultipleNestedPairedTags(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    [Description("Checks each paired tag")]
    public void Parse_ReturnsIEnumerableTokens_WhenTextWithPairedTagWithoutPair(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextContainsHeaderTag(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextContainsEscapingTag(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextContainsOverlappingTags(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenBoldTagInsideItalicTag(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenItalicTagInsideBoldTag(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextWithNumbersAndContainsBoldItalicTags(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextWithWhiteSpaceAndContainsBoldItalicTags(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public void Parse_ReturnsIEnumerableTokens_WhenTextContainsBoldItalicTagsInMiddleWords(string input,  IEnumerable<Token> expectedResult)
    {
        var result = parser.Parse(input);
    ...
    public static IEnumerable<TestCaseData> CasesWhenTextWithOnePairedTag()
    {
        ...
        {
            yield return new TestCaseData($"{tagContent}wordA wordB{tagContent}", new[] { new Token(tagType, "wordA wordB") });
    ...
    public static IEnumerable<TestCaseData> CasesWhenTextWithPairedTagWithoutPair()
    {
        foreach (var (tagType, tagContent) in pairedTags)
        {
            yield return new TestCaseData($"{tagContent}wordA", new[] { new Token(TagType.None, $"{tagContent}wordA") });
        }
    }
    ...
    {
        yield return new TestCaseData("__wordA_wordB__wordC_", new[] { new Token(TagType.None, "__wordA_wordB__wordC_") });
        yield return new TestCaseData("_wordA__wordB_wordC__ wordD", new[] { new Token(TagType.None, "_wordA__wordB_wordC__ wordD") });
    }
    ...
    {
        yield return new TestCaseData("__word1 word2 word3__", new[] { new Token(TagType.None, "__word1 word2 word3__") });
    ...
    public static IEnumerable<TestCaseData> CasesWhenTextWithWhiteSpaceAndContainsBoldItalicTags()
    {
        ...
        yield return new TestCaseData("_ wordA_", new[] { new Token(TagType.None, "_ wordA"), new Token(TagType.None, "_") });
        yield return new TestCaseData("__ wordA__", new[] { new Token(TagType.None, "__ wordA"), new Token(TagType.None, "__") });
    }
    
    public static IEnumerable<TestCaseData> CasesWhenTextContainsBoldItalicTagsInMiddleWords()
    {
        yield return new TestCaseData("_wor_dA", new[] { new Token(TagType.Italic, "wor"), new Token(TagType.None, "dA") });
        yield return new TestCaseData("__wor__dA", new[] { new Token(TagType.Bold, "wor"), new Token(TagType.None, "dA") });
        yield return new TestCaseData("_wordA wor_dB", new[] { new Token(TagType.None, "_wordA wor_"), new Token(TagType.None, "dB") });
        yield return new TestCaseData("__wordA wor__dB", new[] { new Token(TagType.None, "__wordA wor__"), new Token(TagType.None, "dB") });
    }
}